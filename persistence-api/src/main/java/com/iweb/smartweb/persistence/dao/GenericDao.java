...
public interface GenericDao<T, PK extends Serializable> {
     ...
     */
    T load(PK primaryKey) throws DaoException;
     ...
     */
    PaginationResult<T> selectPagination(DynamicSqlParameter param);
     ...
     * @return PaginationResult对象，包括（符合条件的）总记录数、页实体对象List等
     */
    PaginationResult<T> selectFkPagination(DynamicSqlParameter param);
